...
<div class="container-fluid invoice-container">
    ...
    {else}
        <div class="row invoice-header">
            <div class="invoice-col">
                ...
                <table>
                    <tr>
                        <th class="tel">Tel:</th>
                        <td class="tel">0161 615 4360</td>
                    </tr>
                    <tr>
                        <th class="fax">Fax:</th>
                        <td class="fax">0161 615 4360</td>
                    </tr>
                    <tr>
                        <th class="email">Email:</th>
                        <td class="email">billing@ukwsd.com</td>
                    </tr>
                </table>
            </div>
        ...
        <div class="row">
            <div class="invoice-col right">
                ...
                <address class="small-text">
                    {$payto}
                    {if $taxCode}<br/>{$taxIdLabel}: {$taxCode}
                    {else}
                        <br/>VAT No: GB 125 5100 58
                    {/if}
                </address>
            </div>
            <div class="invoice-col">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><strong>Payment by Credit/Debit Card</strong></h3>
            </div>
            <div class="panel-body">
                Card payments are applied instantly to your account; you can make your payment securely from your
                customer portal account.
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><strong>Payment by Bank Transfer (BACS)</strong></h3>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <p>Please quote the invoice number [{$invoicenum}] as your reference when making your payment.</p>
                    <table class="table table-condensed">
                        <tr>
                            <th>Bank:</th>
        ...
        <div class="pull-right btn-group btn-group-sm hidden-print">
            ...
            <a href="dl.php?type=i&amp;id={$invoiceid}" class="btn btn-default"><i
                        class="fas fa-download"></i> {$LANG.invoicesdownload}</a>
        </div>
    {/if}

</div>

<p class="text-center hidden-print"><a href="clientarea.php?action=invoices">{$LANG.invoicesbacktoclientarea}</a></a>
</p>
